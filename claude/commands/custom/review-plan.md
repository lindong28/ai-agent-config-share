...
若审查发现现有原则未覆盖某类问题，提议改进 `~/.claude/references/plan-review-principles.md`（用户决定）。改完后执行 `/custom:review-principles plan-review-principles.md` 循环审查改动——principles 文件本身也要过 meta-原则。
