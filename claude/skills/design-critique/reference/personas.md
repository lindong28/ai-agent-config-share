...
If the project provides design context (target audience + brand personality — from project docs, a design brief, or the user directly), derive 1–2 additional personas from the audience and brand information:
...
**Profile**: [2-3 key characteristics derived from the design context]
...
Only generate project-specific personas when real design context is available. Don't invent audience details — use the 5 predefined personas when no context exists.
